...
#### Класс Page
Отвечает за отображение главной страницы, счетчика корзины\
Поля:
- catalog: HTMLElement - контейнер разметки для отрисовки карточек
- basket: HTMLElement - элемент корзины (кнопка)
- counter: HTMLElement - счетчик корзины

#### Класс Card
Универсальный класс отвечающий за отображение карточки товара\
Поля:
- container: HTMLElement — элемент карточки
- сеттеры и геттеры для сохранения и получения данных
...
#### Класс Modal
Универсальный класс отвечающий за отображение модального окна. Предоставляет методы open, close, render для управления отображением модального окна\
Поля:
- container: HTMLElement - содержимое модального окна
- closeButton: HTMLButtonElement - кнопка закрытия модального окна

#### Класс Form
Универсальный класс формы. Предназначен для управления состоянием формы\
Поля:
